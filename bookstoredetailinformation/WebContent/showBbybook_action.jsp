       ...
       int bookid=Integer.parseInt(request.getParameter("bookid"));  
         ...
         try
         {
             ...
             //stmt=con.createStatement();
            	 ...
            	 ps = con.prepareStatement("select * from booksinfo where bookid=?");
            	 ps.setInt(1,bookid);
	             rs=ps.executeQuery();
        ...
        <table border="1" cellpadding="5">
            ...
            <tr>
             ...
             %>
                ...
                <td><a href="Updatebook.jsp?bookid=<%=bookid1%>" >Update</a></td>
                <td><a href="Deletebook.jsp?bookid=<%=bookid1%>" >Delete</a></td>
                </tr>
                             <%   
             }%>
